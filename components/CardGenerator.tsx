      ...
      >
        ...
        <div className="h-14 px-4 border-b border-gray-100 flex items-center justify-between bg-white shrink-0 relative z-30">
          ...
          <div className="relative group">
            ...
            {/* Tooltip Content */}
            <div className="absolute top-full right-[-10px] mt-2 w-72 bg-white border border-gray-200 rounded-xl shadow-2xl p-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 translate-y-2 group-hover:translate-y-0 z-50">
